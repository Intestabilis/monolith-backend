...
const partyController = {
  createCampaignInvite: async function (
    req: Request,
    res: Response,
    next: NextFunction,
  ) {
  ...
  getCampaignParty: async function (
    req: Request,
    res: Response,
    next: NextFunction,
  ) {
  ...
  removeCampaignMember: async function (
    req: Request,
    res: Response,
    next: NextFunction,
  ) {
    try {
      ...
      await partyService.removeMember(
        campaignId as string,
